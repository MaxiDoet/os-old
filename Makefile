...
QEMUFLAGS = -boot d -hda hdd.img -device AC97 -netdev user,id=u1,hostfwd=udp:127.0.0.1:5000-:23 -device rtl8139,netdev=u1 -object filter-dump,id=f1,netdev=u1,file=dump.dat
