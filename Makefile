...
obj_files := boot/boot.o lib/gui/core/direct.o ./libc/string.o ./kernel/fs/vfs.o ./kernel/fs/ext2.o ./kernel/int_handler.o ./kernel/irq.o ./kernel/net/ethernet.o ./kernel/net/arp.o ./kernel/net/ip.o ./kernel/platform/platform.o ./kernel/platform/smbios.o ./kernel/io.o ./kernel/debug.o ./kernel/idt.o ./kernel/panic.o ./kernel/gdt.o ./kernel/console.o ./kernel/mem/pmm.o ./kernel/mem/heap.o ./kernel/gdt_setup.o ./apps/desktop/desktop.o ./drivers/keyboard.o ./drivers/mouse.o ./drivers/hda.o ./drivers/pci.o ./drivers/ata.o ./drivers/rtl8139.o ./drivers/ac97.o ./drivers/rtc.o ./drivers/pit.o ./drivers/serial.o ./init/main.o
