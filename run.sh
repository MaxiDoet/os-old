...
qemu-system-i386 -boot d -cdrom myos.iso -hda hdd.img -netdev user,id=ul -nic user,id=u1,model=rtl8139,mac=76:36:E8:9F:64:6D,hostfwd=tcp::5555-:22 -object filter-dump,id=f1,netdev=u1,file=dump.dat -nographic
#qemu-system-i386 -boot d -cdrom myos.iso -hda hdd.img -netdev user,id=ul -nic user,id=u1,model=rtl8139,mac=76:36:E8:9F:64:6D,hostfwd=tcp::5555-:22 -object filter-dump,id=f1,netdev=u1,file=dump.dat -nographic
