...
# Linking
ld $LDPARAMS -T linker.ld -o myos.bin kernel/asm.o boot/boot.o init/main.o drivers/vga.o drivers/cmos.o drivers/pci.o drivers/serial.o drivers/bga.o lib/print.o
